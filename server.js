...
import { getRankName } from './server/services/ranks.js';
import { recalcDrawScore, getActiveDrawId } from './server/services/draw.js';
import { generateUniqueAutoNickname, isNicknameValid, nicknameExists, normalizeNickname } from './server/services/nickname.js';
...
function parseTgInitData(initDataStr) {
    if (!initDataStr)
        return null;
    try {
...
app.post('/api/tap', (req, res) => {
    try {
        ...
        const coinsPerTap = GAME_CONFIG.RANK_REWARDS[user.rank_id] || 10;
